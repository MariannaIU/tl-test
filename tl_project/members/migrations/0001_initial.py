    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suite', models.CharField(blank=True, max_length=250, null=True)),
                ...
                ('company_catchPhrase', models.CharField(blank=True, max_length=250, null=True)),
                ('company_bs', models.CharField(blank=True, max_length=250, null=True)),
            ],
        ),
    ]
